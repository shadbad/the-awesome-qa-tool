    ...
    return (
        <>
            ...
            <main className={`layout__body ${appServices.modal !== 'none' ? 'layout__body--inactive' : ''}`}>
                <div className="layout__body__wrapper">{children}</div>
            </main>
            ...
            <aside className={`layout__aside ${appServices.isMenuExpanded ? 'layout__aside--expanded' : ''}`}>
                <p className="layout__aside__info">
                    ...
                    question
                    {`${qaServices.items.length === 1 ? '' : 's'}`}. Feel free to create your own questions.
                </p>
                ...
                <div className="layout__aside__tools">
                    ...
                    <ButtonIcon iconName="trash" text="Delete all" variant="regular" onClick={handleDeleteAllClick} />
