...
const TextInput = function ({ className, label, value, errorMessage, variant, onChange }: PropTypes) {
    ...
    return (
        <div
            className={`text-input${variant === 'multi-line' ? '--multi-line' : ''} 
...
type PropTypes = {
    ...
    value?: string;
    errorMessage?: string;
    onChange?: React.ChangeEventHandler<HTMLInputElement> | React.ChangeEventHandler<HTMLTextAreaElement> | undefined;
};
